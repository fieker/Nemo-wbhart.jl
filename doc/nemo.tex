...
\desc{Return whether $A$ and $B$ certainly represent the same matrix.}

\begin{lstlisting}
!=(A::arb_mat, B::arb_mat)
\end{lstlisting}

\desc{Return whether $A$ and $B$ certainly do not represent the same matrix.}

\begin{lstlisting}
strongequal(A::arb_mat, B::arb_mat)
\end{lstlisting}

\desc{Return whether $A$ and $B$ are equal as sets.}

\begin{lstlisting}
overlaps(A::arb_mat, B::arb_mat)
\end{lstlisting}

\desc{Return whether $A$ and $B$, considered as sets of matrices,
...
\desc{Return whether $A$ contains $B$.}
